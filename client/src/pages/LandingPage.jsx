    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-blue-950 text-white relative overflow-hidden">
      ...
      <header className="relative z-10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <img src="/gic-logo.png" alt="GIC Logo" className="h-16" />
          <div className="flex space-x-4">
            <Link to="/login" className="px-5 py-2 bg-blue-600 hover:bg-blue-700 transition-colors rounded-full font-medium">Login</Link>
            <Link to="/register" className="px-5 py-2 bg-transparent border border-blue-500 hover:bg-blue-800/30 transition-colors rounded-full font-medium">Register</Link>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 py-6 md:py-12 flex flex-col items-center text-center">
        ...
        <div className="mb-10 md:mb-16">
          ...
          <h2 className="text-xl md:text-3xl font-medium mb-5 text-blue-200">
            Submit and manage your organization's details
          </h2>
          <p className="text-lg max-w-2xl mx-auto text-blue-300 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 w-full max-w-5xl">
          ...
          <div className="bg-blue-900/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-blue-700/30 flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-blue-700/70 flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <h3 className="text-xl font-bold mb-2">Register Organization</h3>
            <p className="text-blue-200 text-center">Submit your organization's details and contact information</p>
          </div>
          ...
          <div className="bg-blue-900/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-blue-700/30 flex flex-col items-center">
            ...
            <p className="text-blue-200 text-center">Document the services your organization provides to the public</p>
          </div>
          ...
          <div className="bg-blue-900/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-blue-700/30 flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold mb-2">Keep Info Updated</h3>
            <p className="text-blue-200 text-center">Easily update your organization's information when changes occur</p>
          </div>
        </div>

        {/* CTA section */}
        <div className="mt-4 mb-8">
          <Link to="/register" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 transition-colors rounded-full font-medium text-lg inline-block">
